...
public class Dimens
{
    ...
    public static readonly double SpacingMinus35 = -35; 
    ...
    public static readonly float CornerRadius4 = 4;
    public static readonly float CornerRadius2 = 2;
    public static readonly float CornerRadiusXXs = 8;
    ...
    public static readonly double RadBorderCornerRadius10 = 10;
    public static readonly float RadiusShadowPopup10 = 10;
    public static readonly double RadBorderCornerRadius8 = 8;
    public static readonly double RadBorderCornerRadius4 = 4;
    ...
    public static readonly double IconSize20 = 20;
    ...
    public static readonly double BottomMenuHeight = 56;
    public static readonly double LeftMenuWidth = 264;
